...
$string['sb_blacklisted_software_mac'] = 'Blacklisted Softwares (Mac)';
$string['sb_blacklisted_software_windows'] = 'Blacklisted Softwares (Windows)';
$string['sb_invalid_blacklisted_software_format'] = 'Please provide the list of blacklisted softwares in comma separated format';
